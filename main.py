...
MonsterCSS = Link(
    rel="stylesheet",
    href="https://cdn.jsdelivr.net/npm/monsterui@latest/dist/monsterui.min.css",
)


# Simple navbar using basic HTML structure; classes can be picked up by monsterui if present
def Navbar():
    # Use route function references for `href` so links stay correct when routes rename
    return Div(
        ...
        Div(
            A(
                "Teams",
                href=teams,
                style="margin:0 12px; color:inherit; text-decoration:none;",
            ),
            A(
                "Drivers",
                href=drivers,
...
# Make a funtion for each item in the navbar so we can link to them easily. These will be empty pages for now.
@rt
def teams():
    return Div(
        MonsterCSS,
        Navbar(),
        H1("Teams Page"),
        P("This is the Teams page. Content coming soon!"),
...
def calendar():
    return Div(
        ...
        Navbar(),
        H1("Calendar Page"),
        P("This is the Calendar page. Content coming soon!"),
        style="padding:24px; text-align:center;",
    )
...
def about():
    return Div(
        ...
        Navbar(),
        H1("About Page"),
        P("This is the About page. Content coming soon!"),
        style="padding:24px; text-align:center;",
    )
...
def ex_card2_wide():
    ...
    return Card(
        DivLAligned(
            A(
                Img(
                    src="https://fansbrands.co.uk/cdn/shop/articles/mclaren_auto_5_91765264-1a0b-4147-bc9f-ea0e6e793451.jpg?v=1759868172&width=1600",
                    style="width:200px",
                ),
                href="#",
            ),
...
def index():
    ...
    return Div(
        ...
        Div(
            Img(
                src="/public/f1-logo.svg",
                alt="F1 Logo",
                style="height:64px; display:block; margin:18px auto;",
            ),
